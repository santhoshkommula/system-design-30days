...
Day 3 of 30 — 30-Day System Design Challenge Follow along: LinkedIn | YouTube
| Instagram
What is an API?
API stands for Application Programming Interface.
It’s a set of rules that allows two software applications to communicate with each other.
Think of it as a messenger or bridge between systems.
...
2. The waiter knows the menu (API documentation)
3. The waiter speaks both your language and the kitchen’s (data translation)
The API is the ONLY way the client can communicate with the server. Just like the
waiter is the only way you can get food from the kitchen.
...
→ You see: 32°C and Sunny!
HTTP Methods (API Verbs)
APIs use HTTP methods to tell the server what action to perform. There are 4 main
methods:
...
Online Payment Charges your card via
Stripe/Razorpay POST /payments/charge
Google Maps in
Uber
Gets directions from A to B
GET /directions?
from=A&to=B
Social Media
Share
Posts a tweet via Twitter API POST /tweets/create
...
2. GET, POST, PUT, DELETE = the 4 main actions (CRUD)
3. APIs return data in JSON format
4. Every app you use is powered by APIs
5. API documentation is the menu — always read it first
Resources
REST API Introduction - GeeksforGeeks
What is REST? - freeCodeCamp
What is a RESTful API? - AWS
REST API Examples - Postman
Practice with free APIs: JSONPlaceholder, Dog API
What’s Next?
Day 4: SQL vs NoSQL Databases — Where does all this data actually live? We’ll compare
structured (SQL) vs flexible (NoSQL) databases and learn when to use which.
